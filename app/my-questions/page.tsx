      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 md:py-12">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 sm:mb-8 md:mb-12">
          <div className="flex-1 min-w-0">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-2 break-words">My Questions</h1>
            <p className="text-sm sm:text-base md:text-lg text-gray-600">Manage your posted questions</p>
          </div>
        ...
        {questions.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-12 md:p-16 text-center">
            ...
            <p className="text-gray-600 mb-8 text-lg">Start by asking your first question</p>
            <Link
              href="/questions/new"
              className="inline-block bg-blue-600 text-white px-8 py-3 rounded-xl font-semibold hover:bg-blue-700 transition-all shadow-lg"
            >
